...
import 'package:myprojects/util/colors.dart';
               ...
               child: Column(
                 mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                      ...
                      SizedBox(height: 9),
                    Text(" ${ ( _homePrice > 0 && _interest > 0.0) ? "\$${calculateMonthlyPayment(_homePrice, _interest, _lengthOfLoan)}" : ""}", style: TextStyle(color:secondaryBackgroundWhite ),)
                  ],
               ),
             ),
          ),
          ...
          Container(
            margin: EdgeInsets.only(top: 20),
             decoration: BoxDecoration(
               ...
               border: Border.all(
                  color: Theme.of(context).primaryColorLight, //TODO: theme this!
